...
from mapping import mapping_0p6um_500nm as mm
...
# %%
for T_step in [2, 5, 10]:
# for T_step in [10]:

    for beam_sigma in [50, 100, 150, 200]:
    # for beam_sigma in [5]:

        for exposure_time in range(4, 15, 2):
        # for exposure_time in [100]:
            ...
            path = '/Volumes/Transcend/SIM_DEBER/150C_holo_0p6/' + str(T_step) + 'C_sec/sigma_' + str(beam_sigma) + '/'\
                   + str(exposure_time) + '/'
