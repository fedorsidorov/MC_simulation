...
plt.savefig('holo_1C_s450_40s_um_300dpi.jpg', dpi=300, bbox_inches='tight')
plt.show()
...
plt.savefig('holo_1C_s450_48s_um_300dpi.jpg', dpi=300, bbox_inches='tight')
plt.show()
...
plt.savefig('holo_1C_s500_48s_um_300dpi.jpg', dpi=300, bbox_inches='tight')
plt.show()
...
plt.savefig('holo_1C_s600_40s_um_300dpi.jpg', dpi=300, bbox_inches='tight')
plt.show()
...
plt.savefig('holo_1C_s600_62s_um_300dpi.jpg', dpi=300, bbox_inches='tight')
plt.show()
...
plt.plot((xx_bins - 500) / 1000, zz_bins, 'C3', label=r'поверхность ПММА')
plt.plot((xx_bins - 500) / 1000, func_cos(xx_bins, *popt), 'k--', label=r'$h_0 + A \cdot sin(2 \pi x / \lambda)$')
...
plt.savefig('holo_10C_s250_100s_um_300dpi.jpg', dpi=300, bbox_inches='tight')
plt.show()
