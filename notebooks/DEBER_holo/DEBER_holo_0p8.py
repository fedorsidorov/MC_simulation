...
from mapping import mapping_0p8um_500nm as mm
...
for T_step in [1, 2, 5]:
    ...
    for beam_sigma in [150, 200, 250]:

        # for exposure_time in range(15, 36, 5):
        for exposure_time in range(10, 21, 2):
            ...
            path = '/Volumes/Transcend/SIM_DEBER/150C_holo_0p8/' + str(T_step) + 'C_sec/sigma_' + str(beam_sigma) + '/'\
                   + str(exposure_time) + '/'
