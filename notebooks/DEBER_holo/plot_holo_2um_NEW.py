...
plt.plot((xx_total - 2000) / 1000, zz_total, 'C0', label=r'reflow surface')
plt.plot((xx_bins - 2000) / 1000, zz_bins, 'C3', label=r'PMMA surface')
...
# plt.savefig('holo_' + str(T_step) + 'C_s' + str(beam_sigma) + '_' + str(t_exp) + 's_um_ENG.jpg', dpi=300, bbox_inches='tight')
plt.show()
