...
# %% C1 - YES
C1_a = np.loadtxt('notebooks/DEBER_profiles/357/C/C1_a.csv', delimiter=',', skiprows=5)
C1_b = np.loadtxt('notebooks/DEBER_profiles/357/C/C1_b.csv', delimiter=',', skiprows=5)
C1_c = np.loadtxt('notebooks/DEBER_profiles/357/C/C1_c.csv', delimiter=',', skiprows=5)
C1_d = np.loadtxt('notebooks/DEBER_profiles/357/C/C1_d.csv', delimiter=',', skiprows=5)
...
# %% C2 - YES
C2_a = np.loadtxt('notebooks/DEBER_profiles/357/C/C2_a.csv', delimiter=',', skiprows=5)
C2_b = np.loadtxt('notebooks/DEBER_profiles/357/C/C2_b.csv', delimiter=',', skiprows=5)
C2_c = np.loadtxt('notebooks/DEBER_profiles/357/C/C2_c.csv', delimiter=',', skiprows=5)
C2_d = np.loadtxt('notebooks/DEBER_profiles/357/C/C2_d.csv', delimiter=',', skiprows=5)
...
# %% C5 - YES
C5_a = np.loadtxt('notebooks/DEBER_profiles/357/C/C5_a.csv', delimiter=',', skiprows=5)
C5_b = np.loadtxt('notebooks/DEBER_profiles/357/C/C5_b.csv', delimiter=',', skiprows=5)
C5_c = np.loadtxt('notebooks/DEBER_profiles/357/C/C5_c.csv', delimiter=',', skiprows=5)
C5_d = np.loadtxt('notebooks/DEBER_profiles/357/C/C5_d.csv', delimiter=',', skiprows=5)
