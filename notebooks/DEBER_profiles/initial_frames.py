...
# pr_1 = np.loadtxt('notebooks/DEBER_profiles/Fedor/357/15now21/D1_a.csv', delimiter=',', skiprows=5)
# pr_2 = np.loadtxt('notebooks/DEBER_profiles/Fedor/357/15now21/D2_a.csv', delimiter=',', skiprows=5)
# pr_3 = np.loadtxt('notebooks/DEBER_profiles/Fedor/357/15now21/D3_a.csv', delimiter=',', skiprows=5)
# pr_4 = np.loadtxt('notebooks/DEBER_profiles/Fedor/357/15now21/D4_a.csv', delimiter=',', skiprows=5)

# pr_1 = np.loadtxt('notebooks/DEBER_profiles/Fedor/357/15now21/D5_a.csv', delimiter=',', skiprows=5)
# pr_2 = np.loadtxt('notebooks/DEBER_profiles/Fedor/357/15now21/D6_a.csv', delimiter=',', skiprows=5)
# pr_3 = np.loadtxt('notebooks/DEBER_profiles/Fedor/357/15now21/D7_a.csv', delimiter=',', skiprows=5)
# pr_4 = np.loadtxt('notebooks/DEBER_profiles/Fedor/357/15now21/D8_a.csv', delimiter=',', skiprows=5)
...
# %% 359 - D1x
# pr_1 = np.loadtxt('notebooks/DEBER_profiles/Fedor/359/15now21/D1_a.csv', delimiter=',', skiprows=5)
# pr_2 = np.loadtxt('notebooks/DEBER_profiles/Fedor/359/15now21/D1_d.csv', delimiter=',', skiprows=5)
# pr_3 = np.loadtxt('notebooks/DEBER_profiles/Fedor/359/15now21/D2_a.csv', delimiter=',', skiprows=5)
# pr_4 = np.loadtxt('notebooks/DEBER_profiles/Fedor/359/15now21/D2_d.csv', delimiter=',', skiprows=5)
...
pr_1 = np.loadtxt('notebooks/DEBER_profiles/Fedor/359y/slice_1/D1/D1_a.csv', delimiter=',', skiprows=5)
pr_2 = np.loadtxt('notebooks/DEBER_profiles/Fedor/359y/slice_1/D1/D1_b.csv', delimiter=',', skiprows=5)
pr_3 = np.loadtxt('notebooks/DEBER_profiles/Fedor/359y/slice_1/D1/D1_c.csv', delimiter=',', skiprows=5)

# pr_1 = np.loadtxt('notebooks/DEBER_profiles/Fedor/359/15now21/D7_a.csv', delimiter=',', skiprows=5)
# pr_2 = np.loadtxt('notebooks/DEBER_profiles/Fedor/359/15now21/D8_a.csv', delimiter=',', skiprows=5)
# pr_3 = np.loadtxt('notebooks/DEBER_profiles/Fedor/359/15now21/D11_a.csv', delimiter=',', skiprows=5)
# pr_4 = np.loadtxt('notebooks/DEBER_profiles/Fedor/357/15now21/D8_a.csv', delimiter=',', skiprows=5)
...
# pr_1 = np.loadtxt('notebooks/DEBER_profiles/Fedor/359/15now21/D3_a.csv', delimiter=',', skiprows=5)
# pr_2 = np.loadtxt('notebooks/DEBER_profiles/Fedor/359/15now21/D4_a.csv', delimiter=',', skiprows=5)
# pr_3 = np.loadtxt('notebooks/DEBER_profiles/Fedor/359/15now21/D5_a.csv', delimiter=',', skiprows=5)
# pr_4 = np.loadtxt('notebooks/DEBER_profiles/Fedor/359/15now21/D6_a.csv', delimiter=',', skiprows=5)
