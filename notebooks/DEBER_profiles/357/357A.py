...
# %% A1
A1_c = np.loadtxt('notebooks/DEBER_profiles/Fedor/357/A/A1_c.csv', delimiter=',', skiprows=5)
B1_a = np.loadtxt('notebooks/DEBER_profiles/Fedor/357/B/B1_a.csv', delimiter=',', skiprows=5)
