...
# %% B1 - YES
B1_a = np.loadtxt('notebooks/DEBER_profiles/357/357/B/B1_a.csv', delimiter=',', skiprows=5)
B1_b = np.loadtxt('notebooks/DEBER_profiles/357/357/B/B1_b.csv', delimiter=',', skiprows=5)
B1_c = np.loadtxt('notebooks/DEBER_profiles/357/357/B/B1_c.csv', delimiter=',', skiprows=5)
B1_d = np.loadtxt('notebooks/DEBER_profiles/357/357/B/B1_d.csv', delimiter=',', skiprows=5)

B1y = np.loadtxt('notebooks/DEBER_profiles/357/357y/B1/1d.csv', delimiter=',', skiprows=5)
B2y = np.loadtxt('notebooks/DEBER_profiles/357/357y/B2/1c.csv', delimiter=',', skiprows=5)
B3y = np.loadtxt('notebooks/DEBER_profiles/357/357y/B3/1a.csv', delimiter=',', skiprows=5)
...
# %% B2 - NO
# B2_a = np.loadtxt('notebooks/DEBER_profiles/Fedor/357/B/B2_a.csv', delimiter=',', skiprows=5)
# B2_b = np.loadtxt('notebooks/DEBER_profiles/Fedor/357/B/B2_b.csv', delimiter=',', skiprows=5)
# B2_c = np.loadtxt('notebooks/DEBER_profiles/Fedor/357/B/B2_c.csv', delimiter=',', skiprows=5)
# B2_d = np.loadtxt('notebooks/DEBER_profiles/Fedor/357/B/B2_d.csv', delimiter=',', skiprows=5)
#
# plt.figure(dpi=300)
...
# %% B3 - YES
B3_a = np.loadtxt('notebooks/DEBER_profiles/Fedor/357/B/B3_a.csv', delimiter=',', skiprows=5)
B3_b = np.loadtxt('notebooks/DEBER_profiles/Fedor/357/B/B3_b.csv', delimiter=',', skiprows=5)
B3_c = np.loadtxt('notebooks/DEBER_profiles/Fedor/357/B/B3_c.csv', delimiter=',', skiprows=5)
B3_d = np.loadtxt('notebooks/DEBER_profiles/Fedor/357/B/B3_d.csv', delimiter=',', skiprows=5)
...
# %% B8 - MAY BE
B8_a = np.loadtxt('notebooks/DEBER_profiles/Fedor/357/B/B8_a.csv', delimiter=',', skiprows=5)
B8_b = np.loadtxt('notebooks/DEBER_profiles/Fedor/357/B/B8_b.csv', delimiter=',', skiprows=5)
B8_c = np.loadtxt('notebooks/DEBER_profiles/Fedor/357/B/B8_c.csv', delimiter=',', skiprows=5)
B8_d = np.loadtxt('notebooks/DEBER_profiles/Fedor/357/B/B8_d.csv', delimiter=',', skiprows=5)
