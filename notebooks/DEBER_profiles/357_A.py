...
# %% A1 - YES
A1_a = np.loadtxt('notebooks/DEBER_profiles/357/A/A1_a.csv', delimiter=',', skiprows=5)
A1_b = np.loadtxt('notebooks/DEBER_profiles/357/A/A1_b.csv', delimiter=',', skiprows=5)
A1_c = np.loadtxt('notebooks/DEBER_profiles/357/A/A1_c.csv', delimiter=',', skiprows=5)
A1_d = np.loadtxt('notebooks/DEBER_profiles/357/A/A1_d.csv', delimiter=',', skiprows=5)
...
# %% A2 - NO
A2_a = np.loadtxt('notebooks/DEBER_profiles/357/A/A2_a.csv', delimiter=',', skiprows=5)
# A2_b = np.loadtxt('notebooks/DEBER_profiles/357/A/A2_b.csv', delimiter=',', skiprows=5)
# A2_c = np.loadtxt('notebooks/DEBER_profiles/357/A/A2_c.csv', delimiter=',', skiprows=5)
# A2_d = np.loadtxt('notebooks/DEBER_profiles/357/A/A2_d.csv', delimiter=',', skiprows=5)
#
plt.figure(dpi=300)
