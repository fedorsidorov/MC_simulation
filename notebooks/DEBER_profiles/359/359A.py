...
# D1_a = np.loadtxt('notebooks/DEBER_profiles/Fedor/359/15now21/D1_a.csv', delimiter=',', skiprows=5)

D1_a = np.loadtxt('notebooks/DEBER_profiles/Fedor/15 nov 2021/359/D1x_slice_1.csv', delimiter=',', skiprows=5)

plt.figure(dpi=300)
# plt.plot(A1_c[:, 0], A1_c[:, 1], label='A')
# plt.plot(B1_a[:, 0] + 600, B1_a[:, 1] + 1, label='B')
# plt.plot(C1_a[:, 0] + 1400, C1_a[:, 1] + 7, label='C')
# plt.plot(D1_a[:, 0] - 1200, D1_a[:, 1] + 7, label='15now21')
plt.plot(D1_a[:, 0], D1_a[:, 1], label='15now21')
...
# %% A6 - NO
A6_a = np.loadtxt('notebooks/DEBER_profiles/Fedor/357/A/A6_a.csv', delimiter=',', skiprows=5)
A6_b = np.loadtxt('notebooks/DEBER_profiles/Fedor/357/A/A6_b.csv', delimiter=',', skiprows=5)
A6_c = np.loadtxt('notebooks/DEBER_profiles/Fedor/357/A/A6_c.csv', delimiter=',', skiprows=5)
A6_d = np.loadtxt('notebooks/DEBER_profiles/Fedor/357/A/A6_d.csv', delimiter=',', skiprows=5)
...
# %% A7 - NO
A7_a = np.loadtxt('notebooks/DEBER_profiles/Fedor/357/A/A7_a.csv', delimiter=',', skiprows=5)
A7_b = np.loadtxt('notebooks/DEBER_profiles/Fedor/357/A/A7_b.csv', delimiter=',', skiprows=5)
A7_c = np.loadtxt('notebooks/DEBER_profiles/Fedor/357/A/A7_c.csv', delimiter=',', skiprows=5)
A7_d = np.loadtxt('notebooks/DEBER_profiles/Fedor/357/A/A7_d.csv', delimiter=',', skiprows=5)
