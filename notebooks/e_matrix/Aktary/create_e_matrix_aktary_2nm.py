...
# %%
np.save('data/e_matrix/combine_chains/series_1_2nm/e_matrix_val_exc_sci_1500_2nm.npy', e_matrix_val_exc_sci)
np.save('data/e_matrix/combine_chains/series_1_2nm/e_matrix_val_ion_sci_1500_2nm.npy', e_matrix_val_ion_sci)
np.save('data/e_matrix/combine_chains/series_1_2nm/e_matrix_E_dep_1500_2nm.npy', e_matrix_E_dep)
