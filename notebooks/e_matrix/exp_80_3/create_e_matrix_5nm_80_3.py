...
line_pitch_cm = (mapping.x_max - mapping.x_min) * 1e-7
...
plt.figure(dpi=300)
plt.imshow(y_avg_matrix[100:-100, :].transpose())
plt.show()
...
# %%
np.save('data/e_matrix/exp_80_3_5nm/scission_matrix_snaked.npy', e_matrix_val_sci)
np.save('data/e_matrix/exp_80_3_5nm/E_dep_matrix_snaked.npy', e_matrix_E_dep)
