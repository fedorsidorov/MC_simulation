...
plt.figure(dpi=300)
plt.imshow(y_avg_matrix[600:-600, :].transpose())
plt.show()
...
# %%
np.save('data/e_matrix/exp_80_3/scission_matrix_snaked.npy', e_matrix_val_sci)
np.save('data/e_matrix/exp_80_3/E_dep_matrix_snaked.npy', e_matrix_E_dep)
