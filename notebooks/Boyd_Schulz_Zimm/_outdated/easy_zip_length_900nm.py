...
# %%
np.save('notebooks/Boyd_Schulz_Zimm/sim_data/dose_list_900nm_new.npy', dose_list)
np.save('notebooks/Boyd_Schulz_Zimm/sim_data/L_norm_160C_5500_new.npy', L_norm_list)
