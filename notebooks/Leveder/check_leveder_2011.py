...
plt.plot(xx * 1e+6, zz_0*1e+9, '--', label='0')
plt.plot(xx * 1e+6, zz_30*1e+9, '--', label='30')
plt.plot(xx * 1e+6, zz_130*1e+9, '--', label='130')
plt.plot(xx * 1e+6, zz_230*1e+9, '--', label='230')
plt.plot(xx * 1e+6, zz_330*1e+9, '--', label='330')
plt.plot(xx * 1e+6, zz_480*1e+9, '--', label='480')
plt.plot(xx * 1e+6, zz_630*1e+9, '--', label='630')
plt.plot(xx * 1e+6, zz_880*1e+9, '--', label='880')
plt.plot(xx * 1e+6, zz_1180*1e+9, '--', label='1180')
