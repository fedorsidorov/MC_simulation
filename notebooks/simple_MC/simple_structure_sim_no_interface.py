...
import grid
from notebooks.simple_MC import simple_arrays as arr
...
def track_electron(e_id, par_id, E_0, coords_0, flight_ort_0, d_PMMA):
    ...
    while True:
        ...
        u1 = np.random.random()
        free_path = -1 / arr.structure_total_IMFP[layer_ind][E_ind] * np.log(u1)
        ...
        #     p2 = arr.structure_total_IMFP[layer_ind][E_ind]
        ...
        #
        #     if coords[2] > d_PMMA and E < Si_E_pl:  # low-E e comes to Si from PMMA
        #         break
        ...
        elif layer_ind == 1 and proc_ind == 1:  # Si plasmon
            hw = Si_E_pl
            E_bind = Si_E_pl
...
for n in range(n_files):
    ...
    np.save('/Volumes/Transcend/new_e_DATA_80nm/e_DATA_' + str(n) + '.npy', e_DATA)
