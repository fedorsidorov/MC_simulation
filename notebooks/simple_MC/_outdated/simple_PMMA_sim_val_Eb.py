...
# %% load arrays PMMA
PMMA_val_E_bind = 2
PMMA_E_bind = [PMMA_val_E_bind, 284.2, 543.1]
...
PMMA_el_IMFP = np.load('/Users/fedor/PycharmProjects/MC_simulation/notebooks/simple_MC/arrays_PMMA/'
                       'PMMA_el_IMFP_nm.npy')
...
PMMA_C_IMFP = np.load('/Users/fedor/PycharmProjects/MC_simulation/notebooks/simple_MC/arrays_PMMA/'
...
PMMA_O_IMFP = np.load('/Users/fedor/PycharmProjects/MC_simulation/notebooks/simple_MC/arrays_PMMA/'
...
PMMA_pol_IMFP = np.zeros(len(PMMA_pol_IMFP))
...
# E_beam_arr = [50]
E_beam_arr = [50, 100, 150, 200, 250, 300, 400, 500, 600]
...
for n in range(n_files):
    ...
    for E_beam in E_beam_arr:
        ...
        np.save('/Volumes/Transcend/2ndary_val_Eb_2/' + str(E_beam) + '/e_DATA_' + str(n) + '.npy', e_DATA)
