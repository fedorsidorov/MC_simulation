...
# %% load PMMA curves
PMMA_el_IMFP = np.load('/Users/fedor/PycharmProjects/MC_simulation/notebooks/simple_MC/arrays_PMMA/PMMA_el_IMFP_nm.npy')
PMMA_el_DIMFP_cumulated = np.load('/Users/fedor/PycharmProjects/MC_simulation/notebooks/simple_MC/arrays_PMMA/'
                                  'PMMA_el_DIMFP_cumulated.npy')

PMMA_val_IMFP = np.load('/Users/fedor/PycharmProjects/MC_simulation/notebooks/simple_MC/arrays_PMMA/'
...
PMMA_C_IMFP = np.load('/Users/fedor/PycharmProjects/MC_simulation/notebooks/simple_MC/'
                      'arrays_PMMA/PMMA_C_IMFP_E_bind_nm.npy')
PMMA_C_DIMFP_cumulated = np.load('/Users/fedor/PycharmProjects/MC_simulation/notebooks/simple_MC/arrays_PMMA/'
                                 'PMMA_C_DIIMFP_cumulated_E_bind.npy')

PMMA_O_IMFP = np.load('/Users/fedor/PycharmProjects/MC_simulation/notebooks/simple_MC/'
                      'arrays_PMMA/PMMA_O_IMFP_E_bind_nm.npy')
PMMA_O_DIMFP_cumulated = np.load('/Users/fedor/PycharmProjects/MC_simulation/notebooks/simple_MC/arrays_PMMA/'
                                 'PMMA_O_DIIMFP_cumulated_E_bind.npy')

# phonon
PMMA_ph_IMFP = np.load('/Users/fedor/PycharmProjects/MC_simulation/notebooks/simple_MC/arrays_PMMA/'
                       'PMMA_ph_IMFP_nm.npy')

# polaron
PMMA_pol_IMFP = np.load('/Users/fedor/PycharmProjects/MC_simulation/notebooks/simple_MC/'
...
# %% load Si curves
Si_el_IMFP = np.load('/Users/fedor/PycharmProjects/MC_simulation/notebooks/simple_MC/arrays_Si/Si_el_IMFP_nm.npy')
Si_el_DIMFP_cumulated = np.load('/Users/fedor/PycharmProjects/MC_simulation/notebooks/simple_MC/arrays_Si/'
