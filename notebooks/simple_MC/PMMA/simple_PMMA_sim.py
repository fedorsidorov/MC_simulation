...
# PMMA_el_IMFP[:228] = PMMA_el_IMFP[0]
...
# %%
PMMA_val_IMFP = np.load('/Users/fedor/PycharmProjects/MC_simulation/notebooks/simple_MC/PMMA/arrays_PMMA/'
                        'PMMA_val_IMFP_nm.npy')
PMMA_val_DIMFP_cumulated = np.load('/Users/fedor/PycharmProjects/MC_simulation/notebooks/simple_MC/PMMA/'
                                   'arrays_PMMA/PMMA_val_DIMFP_cumulated_corr.npy')

PMMA_C_IMFP = np.load('/Users/fedor/PycharmProjects/MC_simulation/notebooks/simple_MC/PMMA/arrays_PMMA/'
                      'PMMA_C_IMFP_E_bind_nm.npy')
PMMA_C_DIMFP_cumulated = np.load('/Users/fedor/PycharmProjects/MC_simulation/notebooks/simple_MC/PMMA/'
                                 'arrays_PMMA/PMMA_C_DIIMFP_cumulated_E_bind.npy')

PMMA_O_IMFP = np.load('/Users/fedor/PycharmProjects/MC_simulation/notebooks/simple_MC/PMMA/arrays_PMMA/'
                      'PMMA_O_IMFP_E_bind_nm.npy')
PMMA_O_DIMFP_cumulated = np.load('/Users/fedor/PycharmProjects/MC_simulation/notebooks/simple_MC/PMMA/'
                                 'arrays_PMMA/PMMA_O_DIIMFP_cumulated_E_bind.npy')

# phonon
PMMA_ph_IMFP = np.load('/Users/fedor/PycharmProjects/MC_simulation/notebooks/simple_MC/PMMA/arrays_PMMA/'
                       'PMMA_ph_IMFP_nm.npy')
...
for n in range(n_files):
    ...
    for E_beam in E_beam_arr:
        ...
        np.save('data/4CASINO/' + str(E_beam) + '/e_DATA_' + str(n) + '.npy',
                e_DATA)
