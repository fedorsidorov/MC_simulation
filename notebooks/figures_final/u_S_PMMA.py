...
with plt.style.context(['science', 'grid', 'russian-font']):
    ...
    ax.loglog(grid.EE[inds], u_mermin[inds], label=r'Мермин')
    ...
    plt.show()
    # fig.savefig('review_figures/u-1_PMMA.jpg', dpi=600)
...
with plt.style.context(['science', 'grid', 'russian-font']):
    ...
    ax.semilogx(grid.EE[inds], S_mermin[inds], label=r'Мермин')
    ...
    plt.show()
    fig.savefig('review_figures/S_PMMA.jpg', dpi=600)
