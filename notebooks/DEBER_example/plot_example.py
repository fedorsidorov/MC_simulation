...
path = '/Volumes/Transcend/SIM_DEBER/150C_100s_example/20_pA_cm/0.2C_sec_1/'
...
plt.title(r'$t$ = 370 с', fontsize=14)
plt.xlabel(r'$x$, мкм')
plt.ylabel(r'$z$, нм')
...
# plt.savefig('example_' + str(ind) + '_NEW_2.jpg', dpi=200, bbox_inches='tight')
plt.savefig('example_370_NEW.jpg', dpi=200, bbox_inches='tight')
plt.show()
