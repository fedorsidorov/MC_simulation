...
# %%
resist_matrix = np.load('/Volumes/Transcend/chains_viscosity_80nm/10nm/resist_matrix_1.npy')
chain_lens = np.load('/Volumes/Transcend/chains_viscosity_80nm/10nm/prepared_chains_1/chain_lens.npy')
...
for n in range(n_chains):
    chain_tables.append(
        np.load('/Volumes/Transcend/chains_viscosity_80nm/10nm/chain_tables_1/chain_table_' + str(n) + '.npy'))
    progress_bar.update()
