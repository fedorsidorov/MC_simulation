...
# %% Interpolate it all
DIIMFP_cumulated =\
    mcf.log_log_lin_interp_2d(grid.EE_prec, grid.EE_prec, DIIMFP_cumulated_prec)(grid.EE, grid.EE)

DIIMFP_cumulated_pre_2 =\
    mcf.log_log_interp(grid.EE_prec, DIIMFP_cumulated_prec, axis=1)(grid.EE)

DIIMFP_cumulated_2 =\
    mcf.log_log_interp(grid.EE_prec, DIIMFP_cumulated_pre_2, axis=0)(grid.EE)
...
plt.figure(dpi=300)
plt.semilogx(grid.EE, DIIMFP_cumulated[E_ind, :])
plt.semilogx(grid.EE, DIIMFP_cumulated_2[E_ind, :], '--')
