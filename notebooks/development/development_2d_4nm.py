...
# %% 2nm histograms
sum_lens_matrix = np.load('data/chains/combine_chains/development/sum_lens_matrix_series_1_4nm_1500_new_2.npy')
n_chains_matrix = np.load('data/chains/combine_chains/development/n_chains_matrix_series_1_4nm_1500_new_2.npy')
