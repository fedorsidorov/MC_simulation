...
# %% 0.5nm histograms
sum_lens_matrix = np.load('data/chains/combine_chains/development/sum_lens_matrix_series_1_05nm_1500.npy')
n_chains_matrix = np.load('data/chains/combine_chains/development/n_chains_matrix_series_1_05nm_1500.npy')
...
np.save('data/chains/combine_chains/development/n_surface_facets_series_1_1500_05nm.npy', n_surface_facets)
