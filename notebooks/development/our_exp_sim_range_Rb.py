...
# %%
for beam_sigma in [100, 200, 300, 400, 500, 600, 700, 800, 900, 1000]:
    ...
    while file_cnt < n_files_required:
        ...
        # now_e_DATA[:, 4] += np.random.uniform(-Rb/2, Rb/2)
    ...
    plt.colorbar()
    # plt.show()
    plt.savefig('norm_30s_sigma_' + str(beam_sigma) + '.jpg', dpi=300)
