...
dose_list = np.load('notebooks/Boyd_kinetic_curves/sim_data/dose_list_900nm_new.npy')
L_norm = np.load('notebooks/Boyd_kinetic_curves/sim_data/L_norm_160C_5500_new.npy')
