...
# 160 C
data = np.loadtxt('data/Boyd_kinetic_curves/kin_curve_160C_900nm.txt')
weight = 0.31
...
# %%
np.save('notebooks/Boyd_kinetic_curves/sim_data/dose_list_900nm_new.npy', dose_list)
np.save('notebooks/Boyd_kinetic_curves/sim_data/L_norm_160C_5500_new.npy', L_norm_list)
