...
# %%
# casino_casnati = np.loadtxt('notebooks/simple_PMMA_MC/PMMA/distributions/Casnati/0.5keV/z_max.dat')
# casino_pouchou = np.loadtxt('notebooks/simple_PMMA_MC/PMMA/distributions/Pouchou/0.5keV/z_max.dat')
# casino_powell = np.loadtxt('notebooks/simple_PMMA_MC/PMMA/distributions/Powell/0.5keV/z_max.dat')

casino_casnati = np.loadtxt('notebooks/simple_PMMA_MC/PMMA/distributions/Casnati/1keV/z_max.dat')
casino_pouchou = np.loadtxt('notebooks/simple_PMMA_MC/PMMA/distributions/Pouchou/1keV/z_max.dat')
casino_powell = np.loadtxt('notebooks/simple_PMMA_MC/PMMA/distributions/Powell/1keV/z_max.dat')

# casino_casnati = np.loadtxt('notebooks/simple_PMMA_MC/PMMA/distributions/Casnati/10keV/z_max.dat')
# casino_pouchou = np.loadtxt('notebooks/simple_PMMA_MC/PMMA/distributions/Pouchou/10keV/z_max.dat')
# casino_powell = np.loadtxt('notebooks/simple_PMMA_MC/PMMA/distributions/Powell/10keV/z_max.dat')
