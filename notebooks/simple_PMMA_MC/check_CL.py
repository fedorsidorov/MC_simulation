...
# %% Z
# casino_casnati = np.loadtxt('notebooks/simple_PMMA_MC/PMMA/distributions/Casnati/0.5keV/cl_z.dat')
# casino_pouchou = np.loadtxt('notebooks/simple_PMMA_MC/PMMA/distributions/Pouchou/0.5keV/cl_z.dat')
# casino_powell = np.loadtxt('notebooks/simple_PMMA_MC/PMMA/distributions/Powell/0.5keV/cl_z.dat')

# casino_casnati = np.loadtxt('notebooks/simple_PMMA_MC/PMMA/distributions/Casnati/1keV/cl_z.dat')
# casino_pouchou = np.loadtxt('notebooks/simple_PMMA_MC/PMMA/distributions/Pouchou/1keV/cl_z.dat')
# casino_powell = np.loadtxt('notebooks/simple_PMMA_MC/PMMA/distributions/Powell/1keV/cl_z.dat')

casino_casnati = np.loadtxt('notebooks/simple_PMMA_MC/PMMA/distributions/Casnati/10keV/cl_z.dat')
casino_pouchou = np.loadtxt('notebooks/simple_PMMA_MC/PMMA/distributions/Pouchou/10keV/cl_z.dat')
casino_powell = np.loadtxt('notebooks/simple_PMMA_MC/PMMA/distributions/Powell/10keV/cl_z.dat')
...
# %% r
casino_casnati = np.loadtxt('notebooks/simple_PMMA_MC/PMMA/distributions/Casnati/0.5keV/cl_r.dat')
casino_pouchou = np.loadtxt('notebooks/simple_PMMA_MC/PMMA/distributions/Pouchou/0.5keV/cl_r.dat')
casino_powell = np.loadtxt('notebooks/simple_PMMA_MC/PMMA/distributions/Powell/0.5keV/cl_r.dat')

# casino_casnati = np.loadtxt('notebooks/simple_PMMA_MC/PMMA/distributions/Casnati/1keV/cl_r.dat')
# casino_pouchou = np.loadtxt('notebooks/simple_PMMA_MC/PMMA/distributions/Pouchou/1keV/cl_r.dat')
# casino_powell = np.loadtxt('notebooks/simple_PMMA_MC/PMMA/distributions/Powell/1keV/cl_r.dat')

# casino_casnati = np.loadtxt('notebooks/simple_PMMA_MC/PMMA/distributions/Casnati/10keV/cl_r.dat')
# casino_pouchou = np.loadtxt('notebooks/simple_PMMA_MC/PMMA/distributions/Pouchou/10keV/cl_r.dat')
# casino_powell = np.loadtxt('notebooks/simple_PMMA_MC/PMMA/distributions/Powell/10keV/cl_r.dat')
