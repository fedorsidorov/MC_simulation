...
# C_sim = np.loadtxt('/Users/fedor/PycharmProjects/MC_simulation/notebooks/simple_PMMA_MC/curves/ciappa2010.txt')
D_sim = np.loadtxt('/Users/fedor/PycharmProjects/MC_simulation/notebooks/simple_PMMA_MC/curves/Dapor_sim.txt')
D_exp = np.loadtxt('/Users/fedor/PycharmProjects/MC_simulation/notebooks/simple_PMMA_MC/curves/Dapor_exp.txt')
