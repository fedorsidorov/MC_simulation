...
Si_el_IMFP = np.load('/Users/fedor/PycharmProjects/MC_simulation/Resources/ELSEPA/simple_Si_MC/Si_muffin_u.npy') * 1e-7
Si_el_DIMFP_cumulated = np.load('/Users/fedor/PycharmProjects/MC_simulation/Resources/ELSEPA/simple_Si_MC/' +
