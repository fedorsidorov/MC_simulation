...
def print_2ndaries(model, n_tracks):
    ...
    for E_str in E_str_list:
        ...
        if E_str == '.DS_Store' or E_str == '800' or E_str == '1000':
            continue
...
# %%
data = print_2ndaries('1p5_0p14', 100)
...
# %%
ans = np.load('data/2ndaries/1p5_0p14/200/e_DATA_outer_6.npy')
