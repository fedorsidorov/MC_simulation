...
# %%
bin_centrers, hist_my = get_2ndary_hist('data/4Akkerman/10000/', 100, 100)

# %%
paper_hist = np.loadtxt('notebooks/Si_distr_check/curves_2010/Si_2naries_10keV_2010.txt')
paper_x = paper_hist[:, 0]
paper_y = paper_hist[:, 1]
