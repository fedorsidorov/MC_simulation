...
for i in range(n_files):
    ...
    # now_data = np.load('data/4Akkerman/1keV_pl_old/e_DATA_' + str(i) + '.npy')
    # now_data = np.load('/Volumes/ELEMENTS/si_si_si/1000/e_DATA_' + str(i) + '.npy')

    # now_data = np.load('data/4Akkerman/10000/e_DATA_' + str(i) + '.npy')
...
paper_100eV = np.loadtxt('notebooks/Si_distr_check/curves_2010/Si_dose_250eV_2010.txt')
