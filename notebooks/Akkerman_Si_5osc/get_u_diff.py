...
# %%
paper_arr = np.loadtxt('/Users/fedor/PycharmProjects/MC_simulation/notebooks/Akkerman_Si_5osc/curves/ELF_q_Akkerman.txt')
...
# for n_shell in [5]:
    ...
    np.save('notebooks/Akkerman_Si_5osc/DIIMFP_5osc_edge/DIIMFP_' + str(n_shell) + '.npy', DIIMFP)
    np.save('notebooks/Akkerman_Si_5osc/DIIMFP_5osc_edge/u_diff_prec' + str(n_shell) + '.npy', DIIMFP_prec)

    # np.save('notebooks/Akkerman_Si_5osc/u_diff/DIIMFP_' + str(n_shell) + '.npy', u_diff)
