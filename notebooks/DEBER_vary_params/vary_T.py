...
axs[0, 0].plot(xx_bins / 1000, zz_bins_149_avg, label=r'$149^\circ$C')
axs[0, 0].plot(xx_bins / 1000, zz_REF - 2, 'k--', label=r'$150^\circ$C')
axs[0, 0].plot(xx_bins / 1000, zz_REF + 2, 'k--')
axs[0, 0].plot(xx_bins / 1000, zz_bins_153_avg, label=r'$153^\circ$C')
...
axs[1, 0].plot(xx_bins / 1000, zz_bins_149_avg, label=r'$149^\circ$C')
axs[1, 0].plot(xx_bins / 1000, zz_REF - 2, 'k--', label=r'$150^\circ$C')
axs[1, 0].plot(xx_bins / 1000, zz_REF + 2, 'k--')
axs[1, 0].plot(xx_bins / 1000, zz_bins_153_avg, label=r'$153^\circ$C')
...
axs[0, 1].plot(xx_bins / 1000, zz_bins_149_avg, label=r'$149^\circ$C')
axs[0, 1].plot(xx_bins / 1000, zz_REF - 2, 'k--', label=r'$150^\circ$C')
axs[0, 1].plot(xx_bins / 1000, zz_REF + 2, 'k--')
axs[0, 1].plot(xx_bins / 1000, zz_bins_153_avg, label=r'$153^\circ$C')
...
axs[1, 1].plot(xx_bins / 1000, zz_bins_149_avg, label=r'$149^\circ$C')
axs[1, 1].plot(xx_bins / 1000, zz_REF - 2, 'k--', label=r'$150^\circ$C')
axs[1, 1].plot(xx_bins / 1000, zz_REF + 2, 'k--')
axs[1, 1].plot(xx_bins / 1000, zz_bins_153_avg, label=r'$153^\circ$C')
