...
for beam_sigma in [400, 450, 500, 550, 600, 650, 700]:
    for power_low in [1.4, 1.45, 1.5, 1.55, 1.6]:
        ...
        path = '/Volumes/Transcend/SIM_DEBER/130C_100s_NEW/sigma_power_low_' + str(beam_sigma) + '_' + str(power_low) + '/'
