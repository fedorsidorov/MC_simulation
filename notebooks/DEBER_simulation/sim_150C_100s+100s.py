...
path = '/Volumes/Transcend/SIM_DEBER/' + str(T_C) + 'C_200s_B/new_s' + str(beam_sigma) + '_z' +\
...
path_load = '/Volumes/Transcend/SIM_DEBER/150C_200s_A/new_s300_z150_pl1.4/'
...
# np.save(path + 'Mn_centers_100s.npy', Mn_centers)
# np.save(path + 'Mn_matrix_100s.npy', Mn_matrix)
# np.save(path + 'tau_matrix_100s.npy', tau_matrix)
