...
path = '/Volumes/Transcend/SIM_DEBER/150C_100s_figures/new_s' + str(beam_sigma) + '_z' +\
...
while now_time < 100:
    ...
    np.save(path + 'zz_vac_bins_' + str(now_time) + '.npy', zz_vac_bins)
    np.save(path + 'zz_inner_centers_' + str(now_time) + '.npy', zz_inner_centers)
