...
# %%
# xx_vac_pre = np.linspace(-1000, 1000, 1000)
# zz_vac_pre = (np.cos(xx_vac_pre * 2 * np.pi / 2000) + 1) * 40 * 0

# xx_vac = np.concatenate(([-1e+6], xx_vac_pre, [1e+6]))
# zz_vac = np.concatenate(([zz_vac_pre[0]], zz_vac_pre, [zz_vac_pre[-1]]))
