...
path = 'notebooks/DEBER_simulation/sigma_' + str(beam_sigma) + 'nm/bin_' + str(x_step) +\
       '_nm/zip_' + str(zip_length) + '_kern_' + str(kernel_size) + '_pows_' + \
       str(power_high) + '_' + str(power_low) + '/'

# path = 'notebooks/DEBER_simulation/sigma_' + str(beam_sigma) + 'nm/bin_' + str(x_step) +\
#        '_nm/Mn_' + str(Mn_factor) + '_kern_' + str(kernel_size) + '_pows_' + \
#        str(power_high) + '_' + str(power_low) + '/'
...
while now_time < exposure_time:
    ...
    now_scission_matrix_1nm = np.load(
        ...
        'nm/scission_matrix_1nm_' + str(now_time) + '.npy'
    )
...
# plt.figure(dpi=300)
# plt.plot(x_centers, mobs_1d_array_final_average)
# plt.plot(x_centers, mobs_array_final_filt)
# plt.plot(x_centers, gauss_mobs)
# plt.show()
...
np.save(path + 'SE_xx_surface_FINAL.npy', new_xx_surface)
np.save(path + 'SE_zz_surface_FINAL.npy', new_zz_surface)

new_zz_surface_final = mcf.lin_lin_interp(new_xx_surface, new_zz_surface)(x_bins)

np.save(path + 'SE_zz_surface_FINAL.npy', new_zz_surface_final)
...
np.save(path + 'SE_xx_inner_FINAL.npy', new_xx_inner)
np.save(path + 'SE_zz_inner_FINAL.npy', new_zz_inner)

new_zz_inner_final = mcf.lin_lin_interp(new_xx_inner, new_zz_inner)(x_centers)

np.save(path + 'SE_zz_inner_FINAL.npy', new_zz_inner_final)
...
np.save(path + 'xx_total_FINAL.npy', new_xx_total)
np.save(path + 'zz_total_FINAL.npy', new_zz_total)
