...
OLF_C = np.loadtxt('notebooks/Dapor_easiest/curves/OLF_Ciappa.txt')
...
def get_u_diff(E, hw):
    return const.m * const.e**2 / (2 * np.pi * const.hbar**2 * E) * get_OLF(hw)
...
def get_u(E):
    ...
    return integrate.quad(get_Y, 0, E/2, limit=200)
...
def get_SP(E):
    ...
    return integrate.quad(get_Y, 0, E/2)
...
# %%
u_ciappa = np.loadtxt('notebooks/Dapor_easiest/curves/u_ciappa.txt')
...
# %%
S_ciappa = np.loadtxt('notebooks/Dapor_easiest/curves/S_ciappa.txt')
