...
# %%
d_1 = np.load('notebooks/Mermin/DIIMFP_prec/DIIMFP_000-824.npy')
d_2 = np.load('notebooks/Mermin/DIIMFP_prec/DIIMFP_824-950.npy')
d_3 = np.load('notebooks/Mermin/DIIMFP_prec/DIIMFP_950-999.npy')
...
# %%
# np.save('notebooks/Mermin/DIIMFP_prec/DIIMFP_prec.npy', diff_arr)
