...
# C_sim = np.loadtxt('notebooks/PMMA_2ndary_check/ciappa2010.txt')
D_sim = np.loadtxt('notebooks/PMMA_2ndary_check/Dapor_sim.txt')
D_exp = np.loadtxt('notebooks/PMMA_2ndary_check/Dapor_exp.txt')
