...
for chain_num in range(754):
    now_chain = np.load('data/chains/combine_chains/best_sh_sn_chains/sh_sn_chain_' + str(chain_num) + '.npy')
...
# %% save hist_1nm
np.save('data/chains/combine_chains/best_sh_sn_chains/best_hist_1nm.npy', hist_1nm)
