...
source_folder = '/Volumes/ELEMENTS/chains_viscosity_80nm/' + bin_size + '/prepared_chains_1/'
...
dest_folder = '/Volumes/ELEMENTS/chains_viscosity_80nm/' + bin_size + '/rot_sh_sn_chains_1/'
progress_bar = tqdm(total=len(chain_list), position=0)
