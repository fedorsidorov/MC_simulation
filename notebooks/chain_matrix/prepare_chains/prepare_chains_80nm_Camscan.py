...
for n, chain in enumerate(chain_list):
    np.save('/Volumes/ELEMENTS/chains_950K/prepared_chains/exp_80nm_Camscan/chain_' + str(n) + '.npy', chain)
    progress_bar.update()

np.save('/Volumes/ELEMENTS/chains_950K/prepared_chains/exp_80nm_Camscan/chain_lens.npy', chain_lens_array)
