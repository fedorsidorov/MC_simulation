...
Si_el_IMFP = \
    np.load('/Users/fedor/PycharmProjects/MC_simulation/Resources/ELSEPA/simple_Si_MC/Si_muffin_u.npy')
Si_el_IMFP[:inds.Si_E_cut_ind] = 0  # no life below plasmon energy!
Si_el_DIMFP_norm = \
    np.load('/Users/fedor/PycharmProjects/MC_simulation/Resources/ELSEPA/simple_Si_MC/Si_muffin_diff_cs_plane_norm.npy')
...
PMMA_val_IMFP = \
    np.load('/Users/fedor/PycharmProjects/MC_simulation/Resources/Mermin/IIMFP_Mermin_PMMA.npy')
PMMA_val_DIMFP_norm = \
    np.load('/Users/fedor/PycharmProjects/MC_simulation/Resources/Mermin/DIIMFP_Mermin_PMMA_norm.npy')  # valence - OK

PMMA_ee_DIMFP_norm_3 = np.array((PMMA_val_DIMFP_norm, C_K_ee_DIMFP_norm, O_K_ee_DIMFP_norm))

Si_ee_IMFP_6 = \
    np.load('/Users/fedor/PycharmProjects/MC_simulation/Resources/MuElec/Si_MuElec_IIMFP.npy')
Si_ee_DIMFP_norm_6 = \
    np.load('/Users/fedor/PycharmProjects/MC_simulation/Resources/MuElec/Si_MuElec_DIIMFP_norm.npy')

# electron-phonon interaction
PMMA_ph_IMFP = \
    np.load('/Users/fedor/PycharmProjects/MC_simulation/Resources/PhPol/PMMA_phonon_IMFP.npy')
PMMA_pol_IMFP = \
    np.load('/Users/fedor/PycharmProjects/MC_simulation/Resources/PhPol/PMMA_polaron_IMFP_0p1_0p15.npy')
